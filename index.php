            ...
            ">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-content-copy"></i><span class="hide-menu">Page Layouts </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="table-footable.html" aria-expanded="false"><i class="mdi mdi-tab-unselected"></i><span class="hide-menu">Table Footable</span></a>
                        </li>
                        <li class="sidebar-item">
                                    ...
                                    <div class="ms-auto">
                                        <ul class="list-inline">
                                            <li class="list-inline-item px-2">
                                                <h6 class="text-muted">
                                                    <i class="fa fa-circle me-1 text-success"></i>Free
                                                </h6>
                                            </li>
                                            <li class="list-inline-item px-2">
                                                <h6 class="text-muted">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-12 d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="card-body">
                                ...
                                rounded-circle
                                bg-info
                              "><i data-feather="shopping-cart" class="feather-sm"></i></span>
                                                </td>
                                                <td>
                    ...
                    <div class="col-lg-5 col-md-12 d-flex align-items-stretch">
                      ...
                      ">
                            ...
                            rounded-circle
                            bg-primary
                          "><i data-feather="mail" class="feather-sm"></i></span>
                                        </div>
                          ...
                          ">
                            ...
                            fw-normal
                            text-muted
                          ">Daniel Kristeen, Hanna Giover, Jeffry Brown</span>
                                            <span class="
                            time
                            fs-2
                            text-truncate
                      ...
                      ">
                            ...
                            rounded-circle
                            bg-danger
                          "><i data-feather="globe" class="feather-sm"></i></span>
                                        </div>
                                        <div class="w-75 d-inline-block v-middle pl-2">
                                            <h5 class="
                            text-truncate
                          ...
                          ">
                            ...
                            fw-normal
                            text-muted
                          ">Todays headlines : Breakdancing Grandma Proves
                                                ..</span>
                                            <span class="
                            time
                            fs-2
                      ...
                      ">
                            ...
                            rounded-circle
                            bg-success
                          "><i data-feather="dollar-sign" class="feather-sm"></i></span>
                                        </div>
                                        <div class="w-75 d-inline-block v-middle pl-2">
                                            <h5 class="
                            text-truncate
                          ...
                          ">
                            ...
                            fw-normal
                            text-muted
                          ">$3500 from Krishnan, $2000 from Akhil</span>
                                            <span class="
                            time
                            fs-2
                            text-truncate
                      ...
                      ">
                            ...
                            rounded-circle
                            bg-info
                          "><i data-feather="message-square" class="feather-sm"></i></span>
                                        </div>
                                        <div class="w-75 d-inline-block v-middle pl-2">
                                            <h5 class="
                            text-truncate
                          ...
                          ">
                            ...
                            fw-normal
                            text-muted
                          ">Jhonny : Hey this stuff is awesome and how can i
                                                ..</span>
                                            <span class="
                            time
                            fs-2
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-xlg-3 col-md-6">
                                    <div class="card-body">
                                        ...
                                        <a href="javascript:void(0)" class="me-2"><img src="assets/images/users/1.jpg" alt="user" class="rounded-circle" width="50" /></a>
                                        <a href="javascript:void(0)" class="me-2"><img src="assets/images/users/2.jpg" alt="user" class="rounded-circle" width="50" /></a>
                                        <a href="javascript:void(0)" class="me-2"><img src="assets/images/users/3.jpg" alt="user" class="rounded-circle" width="50" /></a>
                                        <a href="javascript:void(0)" class="me-2"><img src="assets/images/users/4.jpg" alt="user" class="rounded-circle" width="50" /></a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <ul class="list-inline mt-3 p-0 mb-1">
                                        <li class="list-inline-item px-2">
                                            <h6 class="text-muted">
                                                <i class="fa fa-circle me-1 text-success"></i>Mobile
                                            </h6>
                                        </li>
                                        <li class="list-inline-item px-2">
                                            <h6 class="text-muted">
                                                <i class="fa fa-circle me-1 text-primary"></i>Desktop
                                            </h6>
                                        </li>
                                        <li class="list-inline-item px-2">
                                            <h6 class="text-muted">
                                                <i class="fa fa-circle me-1 text-danger"></i>Tablet
                                            </h6>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0 mt-3 table-borderless no-wrap">
                                        <tbody>
                                            <tr>
                                                <td style="width: 90px">
                                                    <img src="assets/images/browser/photoshop.jpg" alt="photoshop" />
                                                </td>
                                                <td style="width: 200px">
                                                    <h4 class="card-title">Photoshop</h4>
                                                    <h6 class="card-subtitle">This is a sample text</h6>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="width: 90px">
                                                    <img src="assets/images/browser/sketch.jpg" alt="sketch" />
                                                </td>
                                                <td style="width: 200px">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card profile-card">
                            <img class="card-img profile-img" src="assets/images/background/socialbg.jpg" alt="Card image" />
                            <div class="
                                                ...
                                                <div class="sl-right">
                                                    <div>
                                                        ...
                                                        <div class="text-nowrap">
                                                            <a href="javascript:void(0)" class="link me-2 font-weight-medium"><i data-feather="message-circle" class="fill-white feather-sm text-info"></i>
                                                                comments</a>
                                                            <a href="javascript:void(0)" class="link me-2 font-weight-medium"><i data-feather="heart" class="fill-white feather-sm text-danger"></i>
                                                                5 Likes</a>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <small class="text-muted pt-4 d-block">Phone</small>
                                <h6>+91 654 784 547</h6>
                                <small class="text-muted pt-4 d-block">Address</small>
